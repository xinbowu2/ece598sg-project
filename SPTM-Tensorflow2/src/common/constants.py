...
NUMBER_OF_TRIALS = 1 #get_from_env('NUMBER_OF_TRIALS', int, 6)
...
ACTIONS_LIST = [MOVE_FORWARD, MOVE_LEFT, MOVE_RIGHT]
...
ACTION_MAX_YIELD_COUNT_BEFORE_RESTART = 80
