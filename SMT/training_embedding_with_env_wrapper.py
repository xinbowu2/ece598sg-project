...
if __name__ == '__main__':
	...
	agent  = models.RL_Agent(environment, optimizer, loss_function, training_embedding=True, num_actions=configuration.TASK.NUM_ACTIONS)
	...
	for i in range(num_iterations):
		...
		bar.finish()
		logger.info('Finished iteration [{}/{}]'.format(i, num_iterations))
